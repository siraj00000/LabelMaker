...
const ManufacturerCreateForm = ({ closeDrawer }: any) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            // Submit the FormData
            submit(values, { method: "POST", action: "/manufacturers" });
        },
    });

    return (
        <DynamicForm title={t('add-manufacturer')} handleSubmit={formik.handleSubmit} closeDrawer={closeDrawer} >
