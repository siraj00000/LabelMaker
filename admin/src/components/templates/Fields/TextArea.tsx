...
export const HorizontalTextAreaField = (props: InputProps) => {
    ...
    <div className="flex flex-col">
      <div className="flex items-start gap-5 w-full">
        ...
        <textarea
          {...props}
          rows={3}
          className="w-3/4 ml-auto border border-secondaryLightGray text-sm rounded-md placeholder:capitalize py-[10px] px-[14px] outline-none resize-none"
        />
      </div>
      {!!errormessage && (
