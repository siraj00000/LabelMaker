...
interface HorizontalSingleSelectProps {
...
export default function HorizontalSingleSelect({ id, data, name, dataKey, label, setFieldValue, fetchRelatedData, placeholder, defaultData }: HorizontalSingleSelectProps) {
  ...
  const filteredData = data ? data.filter((item) => item._id !== id) : null; // Add this line
