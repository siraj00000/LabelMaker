...
class ProductDetailController {
    public async productDetailPage(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            /**
            ...
            if (!label) throw new ErrorResponse(400, dsNErrorMessage);
            ...
            if (!product || !brand) throw new ErrorResponse(400, "Details with this labels are not valid")
            ...
            let carouselDetails: Record<string, any> = {};
            ...
            let supportDetails: Record<string, any> = {
